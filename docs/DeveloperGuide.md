...
1. The command can communicate with the `Model` when it is executed (e.g. to delete a internship).
...
* has a need to manage a significant number of internships
* is a student applying fro internships
* prefer desktop apps over other types
* can type fast
* prefers short, concise, and quick-reference style
* is reasonably comfortable using CLI apps

**Value proposition**: easily manage industry connections
...
|----------|------------------------------------------------|-----------------------------------------------------|-----------------------------------------------|
| `* * *`  | new user                                       | create a new entry                                  | store the connections and internship listings |
| `* * *`  | user keeping track of my internship positions  | modify the details of existing internship positions | aware of the status                           |
| `* * *`  | user keeping trakc of many connections         | modify the details of these connections             | ensure the information remains up-to-date     |
| `* * *`  | user                                           | view everything                                     | keep track of the details                     |
| `* *`    | user                                           | delete my files                                     | declutter my workspace                        |
| `*`      | user with many internships in the address book | sort internships by name                            | locate a internship easily                        |
...
**Use case: Update internship position status**

**MSS**

1.  User requests to update details of existing internship position
2.  AddressBook shows the current internship details for the specified index
3.  User requests to change a specific detail about the internship in the list
4.  AddressBook updates the information and shows the updated internship position
5.  User exits editing mode 
6.  AddressBook saves details to the hard disk
...
* **Private internship detail**: A contact detail that is not meant to be shared with others
...
1. Deleting a internship while all internships are being shown
